...
public sealed class SqlUserRepository : IUserRepository
{
    ...
    public void Register(UserAuthRecord userAuthRecord)
    {
        ...
        cmd.Parameters.AddWithValue("@UserID", userAuthRecord.UserID);
        cmd.Parameters.AddWithValue("@UserName", userAuthRecord.UserName);
        cmd.Parameters.AddWithValue("@Email", userAuthRecord.Email);
        cmd.Parameters.AddWithValue("@Account", userAuthRecord.Account);
        cmd.Parameters.AddWithValue("@PasswordHash", userAuthRecord.PasswordHash);
        cmd.Parameters.AddWithValue("@PasswordSalt", userAuthRecord.PasswordSalt);
        cmd.ExecuteNonQuery();
    }
